...
function Scene({
  ...
  return (
    <>
      ...
      <Center>
        <CadModel url={url} wireframe={wireframe} fitSignal={fitSignal} onLoaded={onLoaded} />
      </Center>
...
function CadRendererInner({ src, name, height = '480px', allowUpload = true, showHint = true }: CadRendererProps) {
    ...
    <div className={styles.root}>
      <div className={styles.toolbar}>
        ...
        <div className={styles.buttons}>
          ...
          {allowUpload && (
            <>
              {url !== src && <button onClick={resetToOriginal}>↺ Original</button>}
        ...
        <CadErrorBoundary key={url} fallback={(error) => <ErrorFallback error={error} />}>
          <Suspense fallback={<Loading />}>
            <Canvas
              ...
              dpr={[1, 2]}
            >
              <Scene url={url} wireframe={wireframe} fitSignal={fitSignal} onLoaded={handleLoaded} />
            </Canvas>
          </Suspense>
        </CadErrorBoundary>
